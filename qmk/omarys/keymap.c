...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_preonic_grid(
      ...
      KC_LCTL, KC_LGUI, KC_LALT, MO(3), LOWER, KC_SPC, KC_SPC, TT(2), KC_MUTE, KC_VOLD, KC_VOLU, KC_PSCR
    ),
    ...
    [_RAISE] = LAYOUT_preonic_grid(
      ...
      KC_LCTL, KC_LGUI, KC_LALT, MO(3),   KC_TRNS, KC_SPC, KC_SPC, KC_TRNS, KC_0,    KC_DOT,  KC_DOT,  KC_ENT
    ),
    ...
    [_ADJUST] = LAYOUT_preonic_grid(
      ...
      _______, RESET,   DEBUG,   _______, _______, _______, _______, KC_BRIU, KC_BRID,  _______, _______, KC_SLEP, 
